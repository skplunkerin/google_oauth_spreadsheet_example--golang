...
// main initializes the project by reading the local `credentials.json` file,
// triggering the OAuth authorization if needed; and then prints the names and
// majors of students from a sample spreadsheet.
//
// https://developers.google.com/sheets/api/quickstart/go#step_3_set_up_the_sample
func main() {
